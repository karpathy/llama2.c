...
def load_hf_model(model_path):
    ...
    for layer in model.layers:
        ...
        layer.attention.wk.weight = nn.Parameter(permute_reverse(hf_dict[f'model.layers.{i}.self_attn.k_proj.weight'], config.n_kv_heads, config.n_kv_heads * config.dim // config.n_heads))
