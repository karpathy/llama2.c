...
```bash
./run -cp stories42M.bin -temp 1.0 -step 256 -prompt "One day, Lily met a Shoggoth"
```
...
```bash
OMP_NUM_THREADS=4 ./run -cp out/model.bin
```
